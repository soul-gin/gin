...
public class RocketMQConfig {
    ...
    public static void buildProducerConfigs(Properties props, DefaultMQProducer producer) {
        ...
        producer.setRetryTimesWhenSendFailed(RocketMQUtils.getInteger(props, PRODUCER_RETRY_TIMES, DEFAULT_PRODUCER_RETRY_TIMES));
        producer.setRetryTimesWhenSendAsyncFailed(RocketMQUtils.getInteger(props,
                PRODUCER_RETRY_TIMES, DEFAULT_PRODUCER_RETRY_TIMES));
        producer.setSendMsgTimeout(RocketMQUtils.getInteger(props, PRODUCER_TIMEOUT, DEFAULT_PRODUCER_TIMEOUT));
    ...
    public static void buildCommonConfigs(Properties props, ClientConfig client) {
        ...
        client.setAccessChannel((RocketMQUtils.getAccessChannel(props, ACCESS_CHANNEL, DEFAULT_ACCESS_CHANNEL)));
