...
package com.apache.rocketmq.flink;

import com.apache.rocketmq.flink.common.serialization.KeyValueDeserializationSchema;
import com.apache.rocketmq.flink.common.util.MetricUtils;
import com.apache.rocketmq.flink.common.util.RetryUtil;
import com.apache.rocketmq.flink.common.util.RocketMQUtils;
import com.apache.rocketmq.flink.common.watermark.WaterMarkForAll;
import com.apache.rocketmq.flink.common.watermark.WaterMarkPerQueue;
...
public class RocketMQSource<OUT> extends RichParallelSourceFunction<OUT>
    ...
    public void run(SourceContext context) throws Exception {
        ...
        int pullBatchSize = RocketMQUtils.getInteger(props, RocketMQConfig.CONSUMER_BATCH_SIZE, RocketMQConfig.DEFAULT_CONSUMER_BATCH_SIZE);
            ...
            if (!restored || offset < 0) {
                ...
                switch (initialOffset) {
                    ...
                    case RocketMQConfig.CONSUMER_OFFSET_TIMESTAMP:
                        offset = consumer.searchOffset(mq, RocketMQUtils.getLong(props,
